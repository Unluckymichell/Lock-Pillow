...
#define DEVICE_NAME "Lock Pillow"

bool isBleConnected = false;

void onUpdateLed(bool num, bool caps, bool scroll);
 ...
 */
 ...
 class OutputCallbacks : public BLECharacteristicCallbacks {
    void onWrite(BLECharacteristic* characteristic) {
        ...
        numlock_state    = !!((report->leds) & (1 << 0));
        capslock_state   = !!((report->leds) & (1 << 1));
        scrolllock_state = !!((report->leds) & (1 << 2));

        Serial.print("LED state: ");
        Serial.print("NUM=");
        Serial.print(numlock_state);
        Serial.print("CAPS=");
        Serial.print(capslock_state);
        Serial.print("SCROLL=");
        Serial.print(scrolllock_state);
        Serial.println();

        onUpdateLed(numlock_state, capslock_state, scrolllock_state);
    }
};
